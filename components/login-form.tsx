...
// Credentials Sign In Form (Luxury 28px aesthetic with 56px pill buttons).
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div className="space-y-2">
        ...
        <Input
          ...
          disabled={loading}
          className={`h-12 rounded-[18px] border-[rgba(255,170,80,0.25)] focus:border-[#FB8500] focus:ring-[#FB8500]/20 bg-[#FFFDF8] text-[#1A1A1A] placeholder:text-[#8A8A8A] ${errors.email ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
          {...register('email')}
        />
        {errors.email && (
      ...
      <div className="space-y-2">
        ...
        <PasswordInput
          ...
          placeholder="••••••••"
          disabled={loading}
          className={`h-12 rounded-[18px] border-[rgba(255,170,80,0.25)] focus:border-[#FB8500] focus:ring-[#FB8500]/20 bg-[#FFFDF8] text-[#1A1A1A] placeholder:text-[#8A8A8A] ${errors.password ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
          {...register('password')}
        />
        {errors.password && (
